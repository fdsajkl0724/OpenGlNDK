...
#ifndef OPENGLNDK_GLSAMPLEBASE_H
#define OPENGLNDK_GLSAMPLEBASE_H
#include <GLES3/gl3.h>
#include <ImageDef.h>
...
#define DEFAULT_OGL_ASSETS_DIR "/sdcard/Android/data/com.boe.www.openglndk/files/Download"
class GLSampleBase {
public:
    GLSampleBase() {
        m_ProgramObj = 0;
...
#endif //OPENGLNDK_GLSAMPLEBASE_H
