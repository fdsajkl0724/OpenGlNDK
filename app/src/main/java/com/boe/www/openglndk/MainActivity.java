package com.boe.www.openglndk;

import com.boe.www.openglndk.audio.AudioCollector;
import com.boe.www.openglndk.egl.EGLActivity;
...
import static com.boe.www.openglndk.MyGLSurfaceView.IMAGE_FORMAT_NV21;
import static com.boe.www.openglndk.MyGLSurfaceView.IMAGE_FORMAT_RGBA;
import static com.boe.www.openglndk.MyNativeRender.SAMPLE_TYPE;
import static com.boe.www.openglndk.MyNativeRender.SAMPLE_TYPE_BASIC_LIGHTING;
import static com.boe.www.openglndk.MyNativeRender.SAMPLE_TYPE_BLENDING;
import static com.boe.www.openglndk.MyNativeRender.SAMPLE_TYPE_COORD_SYSTEM;
import static com.boe.www.openglndk.MyNativeRender.SAMPLE_TYPE_DEPTH_TESTING;
import static com.boe.www.openglndk.MyNativeRender.SAMPLE_TYPE_EGL;
import static com.boe.www.openglndk.MyNativeRender.SAMPLE_TYPE_FBO;
import static com.boe.www.openglndk.MyNativeRender.SAMPLE_TYPE_INSTANCING;
import static com.boe.www.openglndk.MyNativeRender.SAMPLE_TYPE_KEY_AVATAR;
import static com.boe.www.openglndk.MyNativeRender.SAMPLE_TYPE_KEY_BEATING_HEART;
import static com.boe.www.openglndk.MyNativeRender.SAMPLE_TYPE_KEY_BEZIER_CURVE;
import static com.boe.www.openglndk.MyNativeRender.SAMPLE_TYPE_KEY_BIG_EYES;
import static com.boe.www.openglndk.MyNativeRender.SAMPLE_TYPE_KEY_BIG_HEAD;
import static com.boe.www.openglndk.MyNativeRender.SAMPLE_TYPE_KEY_FACE_SLENDER;
import static com.boe.www.openglndk.MyNativeRender.SAMPLE_TYPE_KEY_FBO_BLIT;
import static com.boe.www.openglndk.MyNativeRender.SAMPLE_TYPE_KEY_MRT;
import static com.boe.www.openglndk.MyNativeRender.SAMPLE_TYPE_KEY_MULTI_THREAD_RENDER;
import static com.boe.www.openglndk.MyNativeRender.SAMPLE_TYPE_KEY_RGB2YUV;
import static com.boe.www.openglndk.MyNativeRender.SAMPLE_TYPE_KEY_ROTARY_HEAD;
import static com.boe.www.openglndk.MyNativeRender.SAMPLE_TYPE_KEY_SCRATCH_CARD;
import static com.boe.www.openglndk.MyNativeRender.SAMPLE_TYPE_KEY_SHOCK_WAVE;
import static com.boe.www.openglndk.MyNativeRender.SAMPLE_TYPE_KEY_TBO;
import static com.boe.www.openglndk.MyNativeRender.SAMPLE_TYPE_KEY_TEXT_RENDER;
import static com.boe.www.openglndk.MyNativeRender.SAMPLE_TYPE_KEY_UBO;
import static com.boe.www.openglndk.MyNativeRender.SAMPLE_TYPE_KEY_VISUALIZE_AUDIO;
import static com.boe.www.openglndk.MyNativeRender.SAMPLE_TYPE_PARTICLES;
import static com.boe.www.openglndk.MyNativeRender.SAMPLE_TYPE_PBO;
import static com.boe.www.openglndk.MyNativeRender.SAMPLE_TYPE_SKYBOX;
import static com.boe.www.openglndk.MyNativeRender.SAMPLE_TYPE_STENCIL_TESTING;
import static com.boe.www.openglndk.MyNativeRender.SAMPLE_TYPE_TEXTURE_MAP;
import static com.boe.www.openglndk.MyNativeRender.SAMPLE_TYPE_TRANS_FEEDBACK;
import static com.boe.www.openglndk.MyNativeRender.SAMPLE_TYPE_TRIANGLE;
import static com.boe.www.openglndk.MyNativeRender.SAMPLE_TYPE_VAO;
import static com.boe.www.openglndk.MyNativeRender.SAMPLE_TYPE_YUV_TEXTURE_MAP;

public class MainActivity extends AppCompatActivity implements ViewTreeObserver.OnGlobalLayoutListener ,AudioCollector.Callback, SensorEventListener {
    ...
    protected void onResume() {
        ...
        CommonUtils.copyAssetsDirToSDCard(MainActivity.this, "pikachu", fileDir + "/model");
        CommonUtils.copyAssetsDirToSDCard(MainActivity.this, "car", fileDir + "/model");
            ...
            public void onItemClick(View view, int position) {
                ...
                switch (sampleType) {
                    ...
                    case SAMPLE_TYPE_KEY_SCRATCH_CARD:
                        Bitmap b1 = loadRGBAImage(R.drawable.white);
